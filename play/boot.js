(() => {
 ...
 $('begin').onclick=async()=>{
  ...
  const scripts=['/animation-lab/vendor/phaser-3.90.0.min.js','/animation-lab/feedback.js?v=22','/battle-practice/rules.js?v=1','/animation-lab/special.js?v=23','/battle-practice/music.js?v=1','/battle-practice/practice.js?v=11','/play/encounter.js?v=1','/play/demo.js?v=1','/animation-lab/drawn.js?v=20'];
