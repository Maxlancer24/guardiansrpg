...
(() => {
 ...
 <p>${tr('Combate 2v2 · Equipo seleccionable. Puedes opinar aunque no termines el combate.','2v2 battle · Choose your team. You can leave feedback even without finishing.')}</p>
 ...
 window.DemoFeedbackForm.attach({get victory(){return winner()===0;},get defeat(){return winner()===1;},get round(){return state()?.round||0;}},es,()=> '2v2-'+(window.teamBattleSnapshot?.().team||['jessie','garrick']).sort((a,b)=>['jessie','garrick','zoe'].indexOf(a)-['jessie','garrick','zoe'].indexOf(b)).join('-'));
})();
